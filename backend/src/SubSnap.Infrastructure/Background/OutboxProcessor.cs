...
public sealed class OutboxProcessor : BackgroundService
{
    ...
    {
        await Task.Delay(TimeSpan.FromSeconds(10), ct);  //!!importante un delay!! xk seno altrimenti db online appena parte l'applicazione non è ancora totalmente caricato, dargli tempo x caricare il db!!
