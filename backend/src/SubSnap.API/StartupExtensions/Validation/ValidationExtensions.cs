...
public static class ValidationExtensions
{
    ...
    {
        // here DISABILITO VALIDAZIONE AUTOMATICA ASP.NET x ModelState!! (xk di default [ApiController] (nel controller) fa if (!ModelState.IsValid){return BadRequest(ModelState);}  quindi non ti da possibilita di customizzazione!!) . ora lo hai solo disattivato, fa invece la fluent validation manualmente in API/Validators/ValidatorHelper.cs
